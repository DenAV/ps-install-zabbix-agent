...
The format is based on [Keep a Changelog](https://keepachangelog.com/en/1.1.0/), and this project follows semantic versioning when release tags are created.

## [Unreleased]

### Added
- Documented installer usage, prerequisites, proxy mode, offline MSI usage, and verification notes.
